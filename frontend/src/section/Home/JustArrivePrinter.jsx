...
const JustArrivePrinter = () => {
  return (
    <section className="py-16 sm-py-20 container mx-auto px-6 sm:px-12">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4 mt-3 sm:mt-6">
        <Card className="p-3 bg-(--bg-primary-clr) group">
          ...
          <CardContent className="font-inter">
            ...
            <p className="text-gray-400 text-md mb-2">Excellent Condition</p>
...
export default JustArrivePrinter;
